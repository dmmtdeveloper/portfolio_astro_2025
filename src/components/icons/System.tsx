...
export const SystemIcon = ({ className, id }: SystemIconProps) => {
  return (
    <>
      <svg id={id} className={className} xmlns="http://www.w3.org/2000/svg" width="1.2em" height="1.2em" viewBox="0 0 56 56">
        <path
          fill="currentColor"
